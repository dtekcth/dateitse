...
angular.module('dateitse', [
  ...
  .config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('catalog', {
      ...
      resolve: {
        companies: function ($q, companiesFactory) {
          var deferred = $q.defer();
          deferred.resolve(companiesFactory.GetCompanies());
          return deferred.promise;
        }
      },
      templateUrl: 'catalog-main.tpl.html'
    });
  })
...
CatalogController.$inject = ['$scope', 'companiesFactory'];

function CatalogController($scope, companiesFactory) {
  var vm = this;

  vm.companies = companiesFactory.companies;
